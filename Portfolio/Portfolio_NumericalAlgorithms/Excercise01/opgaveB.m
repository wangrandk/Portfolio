...
%start gæt ligger omrking m
x0=[86.2,0.956];
[m2, Pmin2, ~, output] = fminsearch( @ (x) pris(x(1),x(2),B,L),x0,optionB);
%det skal bruges 30 itteriationer til at opnå pmin2 som er det samme som
%pmin1=1.1214*10^3

%B4
% Ved at kigge på graffen ses at hmin ligger i x=0, ved at indsætte dett, fås hele 0 
%derfor kan det ikke bruges ligesom i opgaveA. Dette skyldes at vi i opgave B nu kigger på et nyt 
